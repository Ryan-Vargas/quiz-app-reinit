...
const store = {
  questions: [
    {
      question: 'Hopoo Games is an indie studio, comprised of how many developers?',
      answers: [
        'Three',
        'Ten',
        'Seventeen',
      ...
      factoid: 'Hopoo Games has three employees, four if you count the composer writing the soundtrack.'
    },
    {
      question: 'There are items in both installments that are references the devs. What is one such item?',
      answers: ['Halcyon Seed', '56 Leaf Clover', 'Hopoo Feather', 'Happiest Mask'],
      correctAnswer: 2,
      incorrectDesc: 'Hopoo Feather, Paul\'s Goat Hoof, and Ghor\'s Tome all reference a developer.',
      factoid:
        'Ghor\'s Tome did not exist in the original game, as Hopoo Games was comprised of only Paul and Hopoo until 2018.',
    },
    {
      question: 'Which environment in Risk of Rain 2 is the only returning stage from the first game?',
      answers: [
        'Abandoned Aqueduct',
        'Sky Meadow',
        'Distant Roost',
      ...
      correctAnswer: 1,
      incorrectDesc: 'Sky Meadow is the only stage that has been reimagined for the second installment.',
      factoid: 'The soundtrack for this stage is also the only soundtrack anywhere in the game that uses interpolations from the first game\'s soundtrack.'
    },
    {
      question: 'What item can you only acquire after having unlocked the achievement Never Back Down?',
      answers: [
        'Strides of Heresy',
        'Transcendence',
        'Focused Convergence',
      ...
      factoid: 'Focused Convergence is a Lunar item that increases teleporter charge rate by 30%, but reduces teleporter charge radius by 50% for each stack of the item.'
    },
    {
      ...
      correctAnswer: 0,
      incorrectDesc: 'Chris Christodoulou composed the soundtrack for Risk of Rain 2',
      factoid: 'Chris has also composed the soundtrack for all of Hopoo\'s games, including Deadbolt and the original Risk of Rain.'
    }
  ],
  quizStarted: false,
  questionNumber: 0,
